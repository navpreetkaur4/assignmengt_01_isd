...
class TestBankAccount(unittest.TestCase):
    ...
    def test_init_attributes(self):
        ...
        account = BankAccount(54675, 8004, 870.00)
    ...
    def test_init_non_numeric_balance(self):
        ...
        account = BankAccount(54675, 8004, "non_numeric")
    ...
    def test_init_non_numeric_account_number(self):
        ...
        with self.assertRaises(ValueError) as context:
            BankAccount("non_numeric", 8004, 870.00)
    ...
    def test_init_non_numeric_client_number(self):
        ...
        with self.assertRaises(ValueError) as context:
            BankAccount(54675, "non_numeric", 870.00)
